...
mkdir -p /gpfs01/home/mbzlld/data/bryant/photorhabdus_assembly/pypolca
cd /gpfs01/home/mbzlld/data/bryant/photorhabdus_assembly/pypolca
...
# polish the assembly
pypolca run -a $assembly -1 $reads1 -2 $reads2 -t 8 --careful
